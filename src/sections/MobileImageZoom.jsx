...
const MobileImageZoom = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="h-[830px] overflow-visible py-5"
    >
      <div className="container mx-auto px-4 mt-10 text-center">
        <div className="relative flex flex-col items-center justify-center">
          ...
          <div className="flex flex-col items-center w-full mt-8">
            {["Next Gen Risk Understanding","Real Time Accident Prevention","Super Charge Existing Video Telematics"].map((title, i) => (
              <div
                key={i}
                ref={stepRefs[i]}
                className={`w-full md:w-2/3 lg:w-1/2 opacity-0 ${i > 0 ? "mt-3" : ""}`}
                style={{ display: "none" }}
              >
